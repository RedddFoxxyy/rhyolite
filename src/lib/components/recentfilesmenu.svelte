...
{#if recentFilesStore.isVisible()}
	...
	>
		<div
			class="fixed top-[40%] left-1/2 flex flex-col bg-crust rounded-lg p-3 z-[60] w-min-[200px] w-[50%] h-[40%] gap-2 -translate-x-1/2 -translate-y-1/2 overflow-hidden shadow-2xl"
		>
			<div
